    ...
    <>
      ...
      <div className="min-h-screen flex flex-col">
        ...
        <main className="flex-1">
          ...
          {/* Dynamic Hero Banner (Responsive) */}

          <section className="relative w-full aspect-[16/9] sm:aspect-[16/8] md:aspect-[16/7] lg:aspect-[16/6] xl:aspect-[16/5] flex items-center justify-center overflow-hidden">
            ...
            {activeBanner && activeBanner.show_text_overlay && (
              <div 
                ...
                className="relative z-10 text-center text-white px-4 sm:px-6 md:px-8 transition-all duration-700 ease-in-out"
              >
                <div className="inline-flex items-center gap-2 px-3 py-1 sm:px-4 sm:py-2 bg-gradient-to-r from-blue-50 to-blue-100 dark:from-blue-950 dark:to-blue-900 rounded-full border border-blue-200 dark:border-blue-800 mb-3 sm:mb-6">
                  <Smartphone className="h-4 w-4 sm:h-5 sm:w-5 text-blue-700 dark:text-blue-400" />
                  <p className="text-xs sm:text-sm font-black text-blue-700 dark:text-blue-400 uppercase tracking-widest">
                    iPHONE STORE
                  </p>
                </div>
                <h1 className="font-display text-3xl sm:text-4xl md:text-6xl lg:text-7xl font-black mb-4 sm:mb-6 drop-shadow-2xl animate-fade-in leading-tight">
                  {activeBanner.title || "Authentic Pre-Owned iPhones"}
                </h1>
                <p className="text-sm sm:text-base md:text-lg lg:text-xl mb-2 sm:mb-8 max-w-md sm:max-w-xl md:max-w-2xl mx-auto drop-shadow-lg animate-fade-in hidden sm:block">
                  {activeBanner.subtitle || "Excellent Quality • Original Condition • Store Warranty"}
                </p>

                <div className="animate-fade-in space-x-2 sm:space-x-4">
                  <Button 
                    asChild 
                    size="lg"
                    className="bg-gradient-to-r from-black via-gray-900 to-black hover:from-gray-900 hover:via-gray-800 hover:to-gray-900 text-white font-bold sm:font-black h-10 sm:h-12 md:h-14 px-5 sm:px-8 text-sm sm:text-base md:text-lg rounded-xl sm:rounded-2xl shadow-2xl hover:shadow-3xl transition-all"
                  >
                    <Link to={activeBanner.link_url || '/shop'}>
                      Shop Now <ArrowRight className="ml-2 h-4 sm:h-5 w-4 sm:w-5" />
                    </Link>
                  </Button>
                </div>
              </div>
            ...
            <div className="container mx-auto px-4">
              <div className="text-center mb-12">
                <div className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-blue-50 to-blue-100 dark:from-blue-950 dark:to-blue-900 rounded-full border border-blue-200 dark:border-blue-800 mb-4">
                  ...
                  <p className="text-sm font-black text-blue-700 dark:text-blue-400 uppercase tracking-widest">
                    iPHONE COLLECTIONS
                  </p>
                </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                <Card className="bg-white dark:bg-gray-900 hover:shadow-xl transition-shadow rounded-2xl border-2 border-gray-200 dark:border-gray-800">
                  <CardContent className="p-6">
                    ...
                    <h3 className="font-bold text-xl mb-2">Excellent condition</h3>
                    <p className="text-sm text-muted-foreground">
                      Original condition, genuine parts only
                    </p>
                  </CardContent>
                </Card>
                <Card className="bg-white dark:bg-gray-900 hover:shadow-xl transition-shadow rounded-2xl border-2 border-gray-200 dark:border-gray-800">
          ...
          <section className="py-20 bg-gradient-to-b from-gray-50 via-white to-gray-50 dark:from-gray-950 dark:via-gray-900 dark:to-gray-950">
            <div className="container mx-auto px-4">
              <div className="text-center mb-12">
                ...
                <p className="text-muted-foreground max-w-3xl mx-auto text-base md:text-lg">
                  Top-rated pre-owned iPhones in original condition. Excellent Condition. Trusted by
                  1,247+ customers.
                </p>
              </div>
              ...
              <div className="flex flex-wrap justify-center gap-6">
                {featuredProducts?.map((product) => {
                  ...
                  const { finalPrice, discount } = calculateSalePrice(
                    product.price,
                    productSale,
                    globalSale,
                  );
                  ...
                  return (
                    <Link
                      ...
                      className="w-full sm:w-[calc(50%-0.75rem)] lg:w-[calc(25%-1.125rem)] min-w-[280px] max-w-[400px]"
                    >
